<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="otp2.aspx.cs" Inherits="CreditCard.otp2" %>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtotp2" runat="server" onkeypress="return isNumberKey(event)" class="form-control" placeholder="OTP"></asp:TextBox>
                                    </div>
                                </div>
