<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="otp3.aspx.cs" Inherits="CreditCard.otp3" %>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtotp3" runat="server" onkeypress="return isNumberKey(event)" class="form-control" placeholder="OTP"></asp:TextBox>
                                        </div>
                                    </div>
